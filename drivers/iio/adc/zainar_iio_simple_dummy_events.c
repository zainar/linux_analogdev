...
/**
 * zn_iio_simple_dummy_read_event_config() - is event enabled?
...
/**
 * zn_iio_simple_dummy_write_event_config() - set whether event is enabled
 * @indio_dev: the device instance data
...
/**
 * zn_iio_simple_dummy_read_event_value() - get value associated with event
...
/**
 * zn_iio_simple_dummy_write_event_value() - set value associate with event
 * @indio_dev: device instance specific data
...
/**
 * zn_iio_simple_dummy_events_register() - setup interrupt handling for events
...
/**
 * zn_iio_simple_dummy_events_unregister() - tidy up interrupt handling on remove
 * @indio_dev: device instance data
 */
